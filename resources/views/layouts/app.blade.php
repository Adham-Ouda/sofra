  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{url('/home')}}"><i class="fa fa-book"></i> <span>Dashboard</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i>Show Restaurants</a></li>
            <li><a href="../../index2.html"><i class="fa fa-circle-o"></i>Restaurants Categories</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="../../index.html"><i class="fa fa-circle-o"></i>Show Orders</a></li>
          </ul>
        </li>
        <li><a href="https://adminlte.io/docs"><i class="fa fa-money"></i> <span>financial operations</span></a></li>
        <li><a href="https://adminlte.io/docs"><i class="fa fa-envelope"></i> <span>Contact us</span></a></li>
        <li class="treeview">
          <a href="#">
